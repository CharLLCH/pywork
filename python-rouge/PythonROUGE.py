...
'''
#输入：
    # guess_summ_list:摘要文件地址列表
    # ref_summ_list:对应每个摘要的参考摘要地址列表
    # 注意，所有的参考摘要需要必须再同一个文件夹下
    # ngram_order:unigram/bigram...the order of N-grams
#输出：
    # (召回率，准确率，F1值)
'''
# Inputs:
...
def PythonROUGE(guess_summ_list,ref_summ_list,ngram_order=2):
    ...
    # 这里，根据ROUGE的输出，抽取我们想要的参数，如召回率，准确率，F值
